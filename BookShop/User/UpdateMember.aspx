<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="UpdateMember.aspx.cs" Inherits="User_UpdateMember" Title="修改个人信息" %>
<asp:Content ID="Content1" ContentPlaceHolderID="FartherMain" Runat="Server">
    ...
    <div class="container" runat="server" style="width:60%" id="tabAddUserInfo"  >
            <div class="panel panel-default" id="tabAddMenber" runat="server" >
            ...
            <div>
                <center>
                <asp:button id="btnSave" runat="server" Text="Update" OnClick="btnUpdate_Click" class="button-save"></asp:button>
                <asp:Button ID="btnReturn" runat="server" Text="Cancel" CausesValidation="False" OnClick="btnCancel_Click" class="button-return"/>
                </center>
             </div>
