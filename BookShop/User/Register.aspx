						...
						<table class="tableBorder" id="tabAddMenber" cellSpacing="0" cellPadding="0" width="95%" align="center"
							...
							<tr>
								...
								<td align="left"><asp:textbox id="txtName" runat="server"  MaxLength="50"></asp:textbox>
                                    <font color="red">*</font><asp:Button ID="btnCheck" runat="server" Text="检测用户" OnClick="btnCheck_Click" CausesValidation="False" />
                                    <asp:Label ID="lblResult" runat="server"></asp:Label><font color="red"><asp:RequiredFieldValidator
                                        ID="rfvLoginName" runat="server" ControlToValidate="txtName" Font-Size="9pt"
                                        Height="1px" Width="117px" Display="Dynamic">会员登录名不能为空</asp:RequiredFieldValidator></font></td>
							</tr>
							<tr>
								<td align="right" style="height: 9px; width: 149px;">密 码：
								</td>
								<td style="height: 9px" align="left"><asp:textbox id="txtPassword" runat="server"  MaxLength="50" TextMode="Password" Width="148px"></asp:textbox><FONT color="red">*<asp:RequiredFieldValidator
