<%@ Page Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="AddAdvancePay.aspx.cs" Inherits="User_AddAdvancePay" Title="会员充值" %>
                            ...
                            <asp:RequiredFieldValidator ID="rfvStatus" runat="server" ControlToValidate="txtStatus"
							 ...
							 <tr style ="font-size: 9pt; font-family: 宋体;">
                                <td align="right" style="height: 24px; width: 158px;">
                                    密码：</td>
                                <td style="height: 24px" align="left">
                                    <asp:textbox id="txtCodePassword" runat="server"  MaxLength="20"></asp:textbox><span
