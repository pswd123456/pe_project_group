			...
			<table  cellSpacing="0" cellPadding="0" width="480" align="center" border="0" bgcolor="#EFF3FB">
				<tr>
					<th  align="left" height="25" colspan="2">
						&nbsp;
						<asp:label id="lblTitleInfo" Runat="server">书籍信息管理</asp:label>
					</th>
				<tr>
				</tr>
			</table>
					...
					<td style="width: 478px">
						<table class="tableBorder" cellSpacing="0" cellPadding="0" width="95%" align="center" border="0">
							...
							<tr>
								...
								<td height="17" style="width: 359px"><asp:textbox id="txtPublishDate" runat="server"></asp:textbox><span style="color: #ff0000">*</span></td>
							</tr>
							<tr>
								<td align="left" height="17">
                                    作者：
							...
							<tr>
								<td align="left" style="height: 20px">是否参与打折：
								</td>
								<td colSpan="3" style="height: 20px"><asp:checkbox id="cbxDiscount" runat="server" AutoPostBack="True"></asp:checkbox></td>
							</tr>
							<tr>
								<td align="left">
                                    图书描述：
							...
							<tr>
								<td align="center" colSpan="4"><br>
									<asp:button id="btnSave" runat="server" Text="保存" OnClick="btnSave_Click"></asp:button><asp:button id="btnReturn" runat="server" Text="返回" CausesValidation="False" OnClick="btnReturn_Click"></asp:button></td>
							</tr>
						</table>
					</td>
				</tr>
