			...
			<table  cellSpacing="0" cellPadding="0" width="100%" align="center"
				...
				<tr>
					<td style="height: 23px">
                        ...
                        <asp:GridView ID="gvOrderList" runat="server"   HorizontalAlign =Center  Width =100% DataKeyNames ="OrderID" AutoGenerateColumns =False PageSize="5" AllowPaging="True" OnPageIndexChanging="gvOrderList_PageIndexChanging" OnRowDeleting="gvOrderList_RowDeleting" CellPadding="4" ForeColor="#333333" GridLines="None">
                        ...
                        <ItemStyle  HorizontalAlign="Center" />
                         ...
                         <asp:TemplateField HeaderText="货品总额">
                                   <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
									<ItemStyle HorizontalAlign="Left" ></ItemStyle>
									<ItemTemplate>
										<%#GetVarGF(DataBinder.Eval(Container.DataItem, "BookFee").ToString()) %>
									</ItemTemplate>                              
                        </asp:TemplateField>
